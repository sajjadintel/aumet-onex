                ...
                <div class="d-flex align-items-center mr-2 py-0">
                    ...
                    <div class="d-flex mr-3">
                        ...
                        <div class="navi navi-hover navi-active navi-link-rounded navi-bold d-flex flex-row">
                            ...
                            <div class="navi-item mr-2">
                                <a href="javascript:;" class="navi-link" onclick="WebApp.loadPage('mysalesnetwork/region/<?php echo $regionId ?>/targetedcountries')">
...
<script src="/assets/js/demo/mysalesnetwork-region-distributors.js"></script>