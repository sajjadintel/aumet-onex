            ...
            <div class="d-flex align-items-baseline flex-wrap mr-5">
                ...
                <div class="d-flex flex-column text-dark-75">
                    ...
                    <span class="svg-icon svg-icon-xxl mr-1">
                        ...
                        Manufacturers Demo Starter
                    </h2>
                    <span class="font-weight-normal font-size-h6 ml-12">Choose a manufacturer to start a personalized demo</span>
                </div>
            </div>
        </div>
...
<div class="d-flex flex-column-fluid p-15">
...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px"
     y="0px" viewBox="0 0 1200 172" style="enable-background:new 0 0 1200 172;" xml:space="preserve">
<path class="st0"
...
<rect x="962.09" y="382.25" width="58" height="4" transform="translate(49.97 -363.56) rotate(15.4)" fill="#fff"></rect>
                ...
                <div class="card-body d-flex justify-content-center flex-column col-lg-6 px-8 py-20 px-lg-20 py-lg-40">
                    ...
                    <h2 class="text-dark font-weight-bolder mb-8">Add Company ID to Start</h2>


                    <form class="d-flex position-relative flex-row-fluid" action="/en/demo/setup" method="post">
