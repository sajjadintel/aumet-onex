                                        ...
                                        <td class="pl-0 py-5">
                                            <div class="symbol symbol-100 symbol-light mr-2">
                                                <span class="symbol-label">
                                                    <img src="<?php echo $objProduct->baseImage ?>" class="h-50 align-self-center" alt="" />
                                                </span>
                                            </div>
                                        </td>
                                        <td class="pl-0">
                                            <a href="#" class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg"><?php echo $objProduct->productTitle ?></a>
                                            <span class="text-muted font-weight-normal d-block"><?php echo substr($objProduct->productSubtitle, 0, 80) ?></span>
                                        </td>
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <div class="table-responsive">
                                <table class="table table-borderless table-vertical-center">
                                    ...
                                    <tbody>
                                    <?php foreach ($arrTargetCountries as $item): ?>
                                        <tr>
                                            <td class="pl-0 py-5">
                                                <div class="symbol symbol-50 symbol-light mr-2">
                                                <span class="symbol-label">
                                                    <img src="/theme/assets/media/svg/flags/<?php echo $item->flag; ?>" class="h-50 align-self-center" alt="" />
                                                </span>
                                                </div>
                                            </td>
                                            <td class="pl-0">
                                                <a href="javascript:;" onclick="WebApp.loadPage('mysalesnetwork/region/<?php echo $item->regionId; ?>/country/<?php echo $item->countryId; ?>')"
                                                   class="text-dark font-weight-bolder text-hover-primary mb-1 font-size-lg"><?php echo $item->country; ?></a>
                                                <span class="text-muted font-weight-bold d-block"><?php echo $item->region; ?></span>
                                            </td>
                                            <td class="text-center">
                                                <span class="text-dark-75 font-size-lg font-weight-bold"><?php echo $item->potentialDistributors; ?></span>
                                            </td>
                                            <td>
                                                <div class="d-flex flex-column w-100 mr-2">
                                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                                        <span class="text-dark mr-2 font-size-lg font-weight-bold"><?php echo $item->aumetIndicator; ?>%</span>
                                                        <span class="text-muted font-size-lg font-weight-bold">Strength</span>
                                                    </div>
                                                    <div class="progress progress-xs w-100">
                                                        <div class="progress-bar bg-<?php echo $item->aumetIndicatorLabel; ?>" role="progressbar" style="width: <?php echo $item->aumetIndicator; ?>%;" aria-valuenow="<?php echo $item->aumetIndicator; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <span class="text-dark-75 font-size-lg font-weight-bold"><?php echo $item->population; ?></span>
                                            </td>
                                            <td class="text-right pr-0">
                                                <a href="javascript:;" class="btn btn-icon btn-light btn-sm" onclick="WebApp.loadPage('mysalesnetwork/region/<?php echo $item->regionId; ?>/country/<?php echo $item->countryId; ?>')">
                                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Navigation/Arrow-right.svg-->
                                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
