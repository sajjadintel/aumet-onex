<div class="topbar">
    <div class="topbar-item">
        <a class="btn btn-icon btn-clean btn-lg mr-1" href="/en/demo/start">
        ...
        <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg" style="">
            <form>
                ...
                <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top"
                     style="background-image: url(/theme/assets/media/misc/bg-2.jpg)">
                    ...
                    <ul class="nav nav-bold nav-tabs nav-tabs-line nav-tabs-line-3x nav-tabs-line-transparent-white nav-tabs-line-active-border-success mt-3 px-8"
                        ...
                        <li class="nav-item">
                            <a class="nav-link show active" data-toggle="tab"
                               href="#topbar_notifications_notifications">Inbox</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#topbar_notifications_events">Calls</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link " data-toggle="tab" href="#topbar_notifications_logs">Others</a>
                        </li>
                    </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active p-8" id="topbar_notifications_notifications" role="tabpanel">
...
<rect fill="#000000" opacity="0.3"
      transform="translate(17.825568, 11.945519) rotate(-19.000000) translate(-17.825568, -11.945519)" x="16.3255682"
...
<path d="M20,22 C21.6568542,22 23,20.6568542 23,19 C23,17.8954305 22,16.2287638 20,14 C18,16.2287638 17,17.8954305 17,19 C17,20.6568542 18.3431458,22 20,22 Z"
      fill="#000000" opacity="0.3"></path>
                        ...
                        <div class="d-flex flex-center pt-7">
                            <a href="#" class="btn btn-primary font-weight-bold text-center">See All</a>
                        </div>
    ...
    <div class="dropdown">
        ...
        <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
            <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                <img class="h-20px w-20px rounded-sm" src="/theme/assets/media/svg/flags/<?php echo $langActiveFlag ?>"
                     alt=""/>
            </div>
        </div>
        <!--end::Toggle-->
    ...
    <div class="topbar-item">
        <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2"
            ...
            <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?php echo $objUser->displayName ? explode(' ', trim($objUser->displayName))[0] : "User" ?></span>
