...
<?php else: ?>
    <div class="container-fluid mb-10">
        <div class="accordion accordion-solid accordion-panel accordion-svg-toggle" id="regionsAccordion">
            <?php foreach ($arrRegions as $objRegion): ?>
            <div class="card">
                <div class="card-header" id="regionsAccordionHeading<?php echo $objRegion->id; ?>">
                    <div class="card-title collapsed" data-toggle="collapse" data-target="#collapse<?php echo $objRegion->id; ?>">
                        <div class="card-label">
                            <div class="row">
                                <div class="col-3">
                                    <?php echo $objRegion->name; ?>
                                </div>
                                <div class="col-9">
                                    <span class="label label-inline label-primary">
                                        <?php
                                            $count = count($objRegion->arrCountries);
                                            if($count == 1) {
                                                echo "1 Country";
                                            }
                                            else {
                ...
                <div id="collapse<?php echo $objRegion->id; ?>" class="collapse" data-parent="#regionsAccordion">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                <tr>
                                    <th scope="col" class="text-uppercase text-primary font-weight-bolder">Country</th>
                                    <th scope="col" class="text-uppercase text-primary font-weight-bolder">Number of Distributors</th>
                                    <th scope="col" class="text-uppercase text-primary font-weight-bolder">Potential Distributors</th>
                                    <th scope="col" class="text-uppercase text-primary font-weight-bolder">Actions</th>
                                </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <td >
                                        <a href="#" class="d-flex align-items-center">
                                            <div class="symbol symbol-25 mr-3">
                                                <img alt="Pic" src="<?php echo $objCountry->CountryFlag; ?>"/>

                                            </div>
                                            <div class="d-flex flex-column text-left">
                                                <span class="text-dark font-weight-bold"><?php echo $objCountry->CountryName; ?></span>
                                            </div>
                                        </a>
                                    </td>
